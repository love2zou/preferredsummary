...
CREATE TABLE IF NOT EXISTS Tb_ZwavData (
    ...
    -- 数字量通道（根据要求最大50个通道）
    Digital1 SMALLINT COMMENT '数字量通道1',
    Digital2 SMALLINT COMMENT '数字量通道2',
    Digital3 SMALLINT COMMENT '数字量通道3',
    Digital4 SMALLINT COMMENT '数字量通道4',
    Digital5 SMALLINT COMMENT '数字量通道5',
    Digital6 SMALLINT COMMENT '数字量通道6',
    Digital7 SMALLINT COMMENT '数字量通道7',
    Digital8 SMALLINT COMMENT '数字量通道8',
    Digital9 SMALLINT COMMENT '数字量通道9',
    Digital10 SMALLINT COMMENT '数字量通道10',
    Digital11 SMALLINT COMMENT '数字量通道11',
    Digital12 SMALLINT COMMENT '数字量通道12',
    Digital13 SMALLINT COMMENT '数字量通道13',
    Digital14 SMALLINT COMMENT '数字量通道14',
    Digital15 SMALLINT COMMENT '数字量通道15',
    Digital16 SMALLINT COMMENT '数字量通道16',
    Digital17 SMALLINT COMMENT '数字量通道17',
    Digital18 SMALLINT COMMENT '数字量通道18',
    Digital19 SMALLINT COMMENT '数字量通道19',
    Digital20 SMALLINT COMMENT '数字量通道20',
    Digital21 SMALLINT COMMENT '数字量通道21',
    Digital22 SMALLINT COMMENT '数字量通道22',
    Digital23 SMALLINT COMMENT '数字量通道23',
    Digital24 SMALLINT COMMENT '数字量通道24',
    Digital25 SMALLINT COMMENT '数字量通道25',
    Digital26 SMALLINT COMMENT '数字量通道26',
    Digital27 SMALLINT COMMENT '数字量通道27',
    Digital28 SMALLINT COMMENT '数字量通道28',
    Digital29 SMALLINT COMMENT '数字量通道29',
    Digital30 SMALLINT COMMENT '数字量通道30',
    Digital31 SMALLINT COMMENT '数字量通道31',
    Digital32 SMALLINT COMMENT '数字量通道32',
    Digital33 SMALLINT COMMENT '数字量通道33',
    Digital34 SMALLINT COMMENT '数字量通道34',
    Digital35 SMALLINT COMMENT '数字量通道35',
    Digital36 SMALLINT COMMENT '数字量通道36',
    Digital37 SMALLINT COMMENT '数字量通道37',
    Digital38 SMALLINT COMMENT '数字量通道38',
    Digital39 SMALLINT COMMENT '数字量通道39',
    Digital40 SMALLINT COMMENT '数字量通道40',
    Digital41 SMALLINT COMMENT '数字量通道41',
    Digital42 SMALLINT COMMENT '数字量通道42',
    Digital43 SMALLINT COMMENT '数字量通道43',
    Digital44 SMALLINT COMMENT '数字量通道44',
    Digital45 SMALLINT COMMENT '数字量通道45',
    Digital46 SMALLINT COMMENT '数字量通道46',
    Digital47 SMALLINT COMMENT '数字量通道47',
    Digital48 SMALLINT COMMENT '数字量通道48',
    Digital49 SMALLINT COMMENT '数字量通道49',
    Digital50 SMALLINT COMMENT '数字量通道50',
	SeqNo                INT    DEFAULT 0      NOT NULL COMMENT '排序号',
	CrtTime              DATETIME              NOT NULL COMMENT '创建时间',
	UpdTime              DATETIME              NOT NULL COMMENT '最后修改时间'
